...
def circuit_search(settings):
    ...
    gate_set = [[0, 1, 1, 4], [2, 3, 2, 5], [0, 5, 2, 6], [1, 6, 1, 7]]
    ...
    searcher = MicrobialGA(
        ...
        fitness_function=KNNFitness(10)
    )
    return searcher
...
if __name__ == "__main__":
    ...
    save_results(df, "~/PycharmProjects/RandomBooleanCircuits/PyCharc_multirun_4_gate_RBC_results.csv")
